...
from lyricalign.datasets.synthetic import build_synthetic_manifest, concat_wavs, shifted_annotations
...
def test_synthetic_requires_adjacent_same_song_and_shifts_character_timeline(tmp_path: Path) -> None:
    ...
    assert concat_wavs([tmp_path / "0.wav", tmp_path / "1.wav"], tmp_path / "out.wav") == 2.0
