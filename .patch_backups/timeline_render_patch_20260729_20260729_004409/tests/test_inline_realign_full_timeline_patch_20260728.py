...
def test_full_timeline_pixel_width_is_bounded() -> None:
    module = load_script('inline_visual_full_timeline_patch', 'analyze_inline_realign_visuals.py')
    assert module.full_timeline_pixel_width(5.0) == 3600
    assert module.full_timeline_pixel_width(240.0) == 5760
    assert module.full_timeline_pixel_width(1000.0) == 9000
