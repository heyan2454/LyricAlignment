...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--render-pairs", action="store_true", help="also render three optional 2-way comparisons")
...
def main() -> int:
    ...
    manifest = {
        ...
        "optional_pairwise_outputs_generated": bool(args.render_pairs),
    }
