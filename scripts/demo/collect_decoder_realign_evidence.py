...
def compact_window(song: str, branch: str, row: dict[str, Any]) -> dict[str, Any]:
    activity = row.get("vocal_activity") or {}
    attempts = []
    for attempt in row.get("attempts") or []:
        input_activity = attempt.get("input_vocal_activity") or {}
        attempts.append({
            "attempt_index": attempt.get("attempt_index"),
            "status": attempt.get("status"),
            "target_character_count": attempt.get("target_character_count"),
            ...
            "lookahead_count": attempt.get("lookahead_count"),
            "budget_support_sec": attempt.get("budget_support_sec"),
            "input_sustained_active_sec": input_activity.get("sustained_active_duration_sec"),
    ...
    return {
        ...
        "startup_vocal_onset_sec": row.get("startup_vocal_onset_sec"),
        "silent_core_skipped": bool(row.get("silent_core_skipped")),
        "core_sustained_active_sec": activity.get("sustained_active_duration_sec"),
        "candidate_character_start": row.get("candidate_character_start"),
        "candidate_character_end": row.get("candidate_character_end"),
    ...
    for song_root in song_roots:
        ...
        song_summary: dict[str, Any] = {
            ...
            "comparison": {
                ...
                "trajectory_hashes": comparison.get("trajectory_hashes"),
        ...
        for branch in BRANCHES:
            ...
            for window in payload.get("window_trace") or []:
                window_rows.append(compact_window(song, branch, window))
