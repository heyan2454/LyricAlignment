#!/usr/bin/env python
"""CLI: run the 00_inventory stage for Detector Production Audit + Realign Gate."""
...
from lyricalign.realign_gate.inventory import run_stage
...
def main(argv: list[str] | None = None) -> None:
    ...
    summary = run_stage(args.run_root, cfg_path)
