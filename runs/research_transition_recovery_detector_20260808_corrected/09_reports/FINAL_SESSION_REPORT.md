...
session_root: `runs/research_transition_recovery_detector_20260808_corrected`
GPU seconds recorded: None

## 1. Transition 比较（model_selection 9 首，tolerance 0.32s, raw decoder, retained 3.0s）

| transition | pooled correct* | 备注 |
|---|---|---|
| T0 oracle-independent | 0.0 | 诊断上界（GT query） |
| T1 direct serial | 0.4905 | 提交内正确率，覆盖 ~40% |
| T2 core-boundary serial | 0.4961 | 同上 |
| T3 stable-boundary serial | 0.479 | 提交内高但覆盖 ~12% |
...
- [ ] `02_transition/TRANSITION_REPORT.json`
- [ ] `02_transition/CANDIDATE_SELECTION.json`
