...
> 主判据 = 长上下文视图 `fixed` 的 0.2s 命中率，逐歌配对；预注册规则见 `docs/status/20260914_concat_arm_prereg.md`。可用存档：['old-r2-750', 'uniform-12000']；缺失：['warmstart-control', 'warmstart-oversample']。
