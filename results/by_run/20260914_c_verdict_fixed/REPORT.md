...
|---|---|---|---|---|---|
| B（上采样）vs 线上旧 750 — 主指标 | 29 | -0.01 | 0.10 | -0.08 | 10/9 |
| A（对照）vs 线上旧 750 — 续训漂移 | 29 | +0.01 | 0.04 | 0.4 | 4/1 |
| B vs A — 上采样的**净效应**（判定用这一行） | 29 | -0.02 | 0.10 | -0.23 | 9/9 |
| B vs 热启动来源（均匀终点） | 29 | -0.01 | 0.10 | -0.08 | 10/9 |
